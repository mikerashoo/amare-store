...
export const fetchTotalLoanPaymentOnDateAction = date => ({
    type: DAILY_ACTIONS.FETCH_TOTAL_LOAN_PAYMENTS_ON_DATE,
    date
});
export const setTotalLoanPaymentOnDateAction = total => ({
    type: DAILY_ACTIONS.SET_TOTAL_LOAN_PAYMENTS_ON_DATE,
    total
});
