...
export const stockReducers = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case STOCK_ACTIONS.ADD_NEW_SELL_ACTION:
            message.loading({ content: 'Saving sell please wait!', key: MESSAGE_ID });
            return {
                ...state,
                data: {
                    ...state.data,
        ...
        case STOCK_ACTIONS.CLEAR_TRANSACTIONS_ACTION:
            message.success({ content: 'Sell registered successfully!', key: MESSAGE_ID, duration: 3 });
